...
#@: Author: Aabha Malik, Manasdeep Singh, Sarthak Srivastav 
...
from sklearn.model_selection import cross_val_score, train_test_split, GridSearchCV, Randomized
...
if __name__.__contains__('__main__'):
    ...
    predict_class = model.predict_classes(covid_img)
    print(f'The given image belongs to {predict_class}')
